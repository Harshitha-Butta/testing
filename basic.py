...
g = git.cmd.Git('https://github.com/Harshitha-Butta/testing')
...
repo = Repo('C:/git practice/testing')
g.pull()
#version=input()
...
g.add('--all')
g.Commit('-m','yes commit frm script',author='harshitha.butta@gmail.com')
